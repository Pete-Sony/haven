...
import { observableSignalIdSchema } from "@/domain/contracts";
...
export const companionActionIdSchema = z.enum(SUPPORT_MEMORY_ACTION_IDS);
...
export function createCompanionFallback(
  ...
  return {
    ...
    promptVersion: "haven-companion-fallback-1",
