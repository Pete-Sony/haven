...
import type { SupportProfileInput } from "@/lib/domain/support-profile";
  ...
  return (
    <section className="plan-card" aria-labelledby="support-card-heading">
      ...
      <div className="flow-progress">
        <span>Optional support card</span>
      ...
      <p>
        ...
        immediate danger, <Link href="/emergency">call 112</Link>.
      </p>
    </section>
  );
}
