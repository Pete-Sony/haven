...
import { MAX_COMPANION_TURNS } from "@/lib/domain/companion";
...
export function VoiceCompanion() {
  ...
  const [status, setStatus] = useState(
    "Speak for up to ten seconds, or type a short message.",
  );
  ...
  return (
    <main id="main" className="content-page">
      ...
      <h1>Say one thing at a time.</h1>
      <p>
        This is a short four-turn reflection, not therapy or emergency care.
        Audio, transcripts, and replies are not saved.
      </p>
      ...
      <section className="plan-card" aria-labelledby="companion-input-heading">
        ...
        <div className="voice-panel">
          ...
          <div>
            ...
            <p>Maximum ten seconds. It leaves the browser only when sent.</p>
          </div>
          {audio && (
            <button
